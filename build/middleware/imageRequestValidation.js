...
var fs_1 = require("fs");
var imageRequestValidation = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var files;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!req.query.filename) return [3 /*break*/, 1];
                res.status(400).send('error, no filename sent with request');
                return [2 /*return*/];
            case 1: return [4 /*yield*/, fs_1.promises.readdir('./src/assets/full')];
            case 2:
                files = _a.sent();
...
exports.default = imageRequestValidation;
